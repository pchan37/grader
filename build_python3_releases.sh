...
tar -czf grader-$1-python3-x86_64-linux.tar.gz grader

echo 'Generating binary for darwin...'
gox -osarch="darwin/amd64"
mv grader_darwin_amd64 grader
tar -czf grader-$1-python3-x86_64-darwin.tar.gz grader

echo 'Generating binary for windows...'
gox -osarch="windows/amd64"
mv grader_windows_amd64.exe grader.exe
zip grader-$1-python3-x86_64-windows.zip grader.exe
